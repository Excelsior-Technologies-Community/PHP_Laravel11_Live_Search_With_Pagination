...
<div class="container py-4">
    <h1 class="fw-bold mb-4">➕ Create New Product</h1>
            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="category" class="form-control" value="{{ old('category') }}" list="category-list" required>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="details" class="form-control" rows="2" required>{{ old('details') }}</textarea>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="low_stock_threshold" class="form-control" value="{{ old('low_stock_threshold', 5) }}" min="1" required>
